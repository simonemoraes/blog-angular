...
export class PostsComponent implements OnInit {
  ...
  loading:boolean = true; // já começará com estado 'carregado'
  posts:any[]; //Propriedade que guardará a lista de posts que será obtida pelo providers

  // Injetando o serviço do blog no construtor da classe do novo componente
